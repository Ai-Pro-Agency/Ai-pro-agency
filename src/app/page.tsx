...
const SERVICES: { icon: typeof Layout; title: string; description: string; color: BadgeColor }[] = [
  {
    icon: Layout,
    title: "Site vitrine",
    description: "Le site que vous auriez dû avoir il y a trois ans.",
    color: "beige",
  },
  {
    icon: RefreshCcw,
    title: "Refonte",
    description: "Votre site actuel mérite mieux. On lui redonne de l'allure.",
    color: "rose",
  },
  {
    icon: Wrench,
    title: "Maintenance",
    description: "79 €/mois, et votre site reste vivant tout seul.",
    color: "green",
  },
];
        ...
        <Container className="relative">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <Reveal delay={0.15}>
              ...
              <p className="mt-6 text-2xl font-serif-display leading-snug sm:text-3xl">
                Avant d&apos;ouvrir mon ordinateur, j&apos;ai fait du
                marketing.
              </p>
              <p className="mt-4 text-lg leading-relaxed text-cream/75">
                Votre site est aligné avec votre positionnement, votre ton, ce
                qui vous rend différent. Et une fois en ligne, je reste là
            ...
            <div className="relative overflow-hidden rounded-3xl bg-ink px-8 py-14 text-center text-cream sm:px-16">
              ...
              <div className="relative">
                ...
                <p className="mx-auto mt-4 max-w-lg text-lg text-cream/75">
                  Téléphone, WhatsApp, email : choisissez le canal qui vous
                  convient.
                </p>
                <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
                  <a
                    href={CONTACT.phoneHref}
                    className="text-lg font-semibold text-cream hover:text-accent-light"
                  >
                    {CONTACT.phone}
                  </a>
